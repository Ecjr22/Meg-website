...
A beautiful, mobile-first, SEO-optimized website for a virtual literacy tutoring business.
...
3. Use Replit's deployment feature to publish to production

## Configuration

### Changing the Booking Link

The booking link (Calendly) is set in multiple components. To update:

1. Search for `BOOKING_LINK` in the following files:
...
2. Replace `https://calendly.com/yourlink` with your actual Calendly URL
...
Fonts are loaded in `client/index.html` and configured in `client/src/index.css`:
...
2. Update `--font-serif` and `--font-sans` in `client/src/index.css`

### Adding a Custom Domain

1. Deploy your site on Replit
2. Go to your Replit project settings
3. Navigate to "Domains"
4. Add your custom domain and follow the DNS configuration instructions

### Adding Analytics

Analytics placeholders are included in `client/index.html`. Uncomment and configure:
...
The contact form stores submissions in memory. To switch to email notifications:
...
4. Update `client/src/pages/Contact.tsx` to use EmailJS

### Using Formspree

1. Sign up at [formspree.io](https://formspree.io)
2. Create a form and get your endpoint
3. Update the form action in `client/src/pages/Contact.tsx`
...
- [x] Fast loading (minimal dependencies, optimized assets)
- [x] Accessible (WCAG-friendly contrast, semantic markup)

### Recommended Next Steps

- [ ] Add real photos/images and optimize with WebP format
...
<img
  ...
  alt="Child reading with Miss Meg"
  loading="lazy"
  width="800"
  height="600"
/>
...
│   ├── src/
│   │   ├── components/
│   │   │   ├── icons.tsx          # Custom botanical SVG icons
...
Copyright © 2024 Roots & Wings Literacy. All rights reserved.
